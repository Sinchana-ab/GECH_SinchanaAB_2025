...
public class HomeController {
	...
	public String saveEmployee(@ModelAttribute("employeeDTO") @Valid EmployeeDTO employeeDTO,
		...
		return "add_employee"; // ✅ Error message correctly displayed
		}
	...
	public String updateEmployee(@ModelAttribute("employeeDTO") @Valid EmployeeDTO employeeDTO,
		  ...
		  if (result.hasErrors()) {
		    ...
		    try {
		        ...
		        model.addAttribute("emailError", e.getMessage());
		        model.addAttribute("employee", employeeService.getEmployee(id)); // ✅ Ensure employee data persists
		        return "edit_employee"; // ✅ Return to the same page with the error message
		    }
	    return "redirect:/";
	}
	@GetMapping("/delete")
